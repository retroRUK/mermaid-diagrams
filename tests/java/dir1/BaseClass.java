...
public class BaseClass {
    ...
    private BaseClass(int arg1, String arg2) {
        this();
    }

    protected BaseClass(List<String> list) {
        this();
    }

    BaseClass(Map<String, Integer> map, boolean flag) {
        this();
    }
    ...
    public String publicFinalStringMethod(String arg) {
        return arg;
    }
    ...
    public synchronized String publicFinalSynchronizedMethodWithReturn() {
        return "";
    }
