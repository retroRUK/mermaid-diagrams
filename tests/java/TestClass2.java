 ...
 */
public class TestClass2 extends BaseClass implements InterfaceA, InterfaceB {
    ...
    public TestClass2(String arg) {
        this();
    }

    private TestClass2(int arg1, String arg2) {
        this();
    }

    protected TestClass2(List<String> list) {
        this();
    }

    TestClass2(Map<String, Integer> map, boolean flag) {
        this();
    }
